...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>menjual bangunan mewah dan kantor</p>
      </div>

      <div class="box">
         <img src="images/icon-5.png" alt="">
         <h3>shops and malls</h3>
         <p>menjual bangunan bekas toko dan mall</p>
      </div>

      <div class="box">
         <img src="images/icon-6.png" alt="">
         <h3>24/7 service</h3>
         <p>service customer 24 jam</p>
      </div>
      ...
      <form action="" method="POST">
         ...
         <div class="price"><i class="fa-solid fa-rupiah-sign"></i><span><?= number_format($fetch_property['price'], 0, ',', '.'); ?></span></div>
            ...
            <div class="flex">
               ...
               <p><i class="fas fa-bed"></i><span><?= $fetch_property['bhk']; ?> kasur</span></p>
               <p><i class="fas fa-trowel"></i><span><?= $fetch_property['status']; ?></span></p>
               <p><i class="fas fa-couch"></i><span><?= $fetch_property['furnished']; ?></span></p>
               <p><i class="fas fa-maximize"></i><span><?= $fetch_property['carpet']; ?> carpet</span></p>
            </div>
            <div class="flex-btn">
