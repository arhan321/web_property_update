...
if(isset($_POST['update'])){
   ...
   $update_listing = $conn->prepare("UPDATE `property` SET property_name = ?, address = ?, price = ?, type = ?, offer = ?, status = ?, furnished = ?, bhk = ?, bedroom = ?, bathroom = ?, carpet = ?, age = ?, total_floors = ?, room_floor = ?, lift = ?, security_guard = ?, play_ground = ?, garden = ?, water_supply = ?, power_backup = ?, parking_area = ?, gym = ?, shopping_mall = ?, hospital = ?, school = ?, market_area = ?, description = ? WHERE id = ?");   
   $update_listing->execute([$property_name, $address, $price, $type, $offer, $status, $furnished, $bhk, $bedroom, $bathroom, $carpet, $age, $total_floors, $room_floor, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $description, $update_id]);
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="number" name="price" required min="0" max="99999999999999999" maxlength="20" value="<?= $fetch_property['price']; ?>" placeholder="enter property price" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <select name="bhk" required class="input">
               <option value="<?= $fetch_property['bhk']; ?>" selected><?= $fetch_property['bhk']; ?> kasur</option>
               <option value="1">1 kasur</option>
               <option value="2">2 kasur</option>
               <option value="3">3 kasur</option>
               <option value="4">4 kasur</option>
               <option value="5">5 kasur</option>
               <option value="6">6 kasur</option>
               <option value="7">7 kasur</option>
               <option value="8">8 kasur</option>
               <option value="9">9 kasur</option>
            </select>
         </div>
         <div class="box">
